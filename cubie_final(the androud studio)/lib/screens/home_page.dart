...
//
//     if (children.isNotEmpty && selectedIndex >= children.length) {
//       _selectChild(children.length - 1, children);
//     }
//   }
//
//   @override
...
//     final appState = Provider.of<AppState>(context);
//     final children = appState.children;
//     final selected = children.isEmpty ? null : children[selectedIndex];
//
//     _handleChildUpdates();
//
//     return AppScaffold(
